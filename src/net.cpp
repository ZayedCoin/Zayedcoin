...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Zayedcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"zayedcoin.net","node.zayedcoin.net"},
    {"zayedcoin.net","node1.zayedcoin.net"},
    {"zayedcoin.net","node2.zayedcoin.net"},
    {"zayedcoin.net","node3.zayedcoin.net"},
    {"zayedcoin.net","node4.zayedcoin.net"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Zayedcoin is probably already running."), addrBind.ToString().c_str());
        else
